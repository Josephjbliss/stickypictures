function go_to_filter_from_url($grid_container) {
  ...
  return 0 == filter.length
    ...
    : ("all" == filter && (link_attr = "*"),
      ...
      void $('.filter-link[data-filter="' + link_attr + '"]').addClass(
        "is-checked"
      ));
}
function init_grid() {
  return 0 == $(".masonry-element").length
    ? !1
    : ($(".masonry").length > 0
        ? ((masonry_opts = masonryOptions), ($grid_container = $(".masonry")))
        : $(".project-masonry").length > 0
        ? ((masonry_opts = projectMasonryOptions),
          ($grid_container = $(".project-masonry")))
        : $(".work-page-masonry").length > 0 &&
          ($grid_container = $(".work-page-masonry")),
      void activate_grid());
}
function activate_grid() {
  return grid_is_active
    ? !1
    : ($(".masonry-element:not(.lazy-loaded)").each(set_grid_elem_height),
      void ($(".work-page-masonry").length > 0
        ? ((is_isotope = !0),
          (grid_is_active = !0),
          ($masonry_obj = $(".work-page-masonry").isotope(
            workPageIsotopeOptions
          )))
        : $grid_container.length > 0 &&
          ((grid_is_active = !0),
...
function updateGrid() {
  return 0 == $(".masonry-element").length
    ? !1
    : (grid_is_active && update_grid_once(),
      void ($("body").hasClass("project-page")
        ? updateProjectGrid()
        : $(window).width() < 600
        ? grid_is_active &&
          (destroyGrid(), go_to_filter_from_url($(".work-page-masonry")))
        : grid_is_active || activate_grid()));
}
...
function updateProjectGrid() {
  $(window).width() < 765 ? destroyGrid() : grid_is_active || activate_grid();
}
function destroyGrid() {
  return grid_is_active
    ? (is_isotope
      ...
      void (grid_is_active = !1))
    : !1;
}
function init_lazyload() {
  var threshold = 50;
  $(window).width() >= 765 && (threshold = 1e3);
  var $win = $(window),
    $lazy_imgs = $("img.lazy"),
    lazyload_params = {
      ...
      load: function(elements_left) {
        after_image_loaded_fns(this),
          $win.trigger("scroll"),
          0 == elements_left && $(window).trigger("resize");
      }
    };
  $("body").is(".single-sp_project") ||
    (lazyload_params.placeholder =
    ...
    $elem.hover(
      function() {
        ...
        $slide.animate({ bottom: 0 }, 400),
          $(this)
            .find("img")
            .animate({ top: "-" + $slide.height() / 2 + "px" }, 400);
      },
      function() {
        var $slide = $(this).find(".project-text");
...
function autoplay_vimeo() {
  video_autoplay && $f($(".project-hero iframe")[0]).api("play");
}
!(function(e, a) {
  "use strict";
  ...
  var t = function(a, s) {
    ...
    function c(a, t) {
      ...
      (s = a.attr("data-swiper-parallax") || "0"),
        ...
        (n = a.attr("data-swiper-parallax-y")),
        i || n
          ? ((i = i || "0"), (n = n || "0"))
          : r()
          ? ((i = s), (n = "0"))
        ...
        a.transform("translate3d(" + i + ", " + n + ",0px)");
    }
    function u(e) {
      return (
        0 !== e.indexOf("on") &&
    ...
    if (
      ...
      ("undefined" != typeof e ||
        (e =
          "undefined" == typeof Dom7
            ...
            : Dom7)) &&
        ((v.$ = e), (v.container = e(a)), 0 !== v.container.length))
    ) {
      ...
      (v.container[0].swiper = v),
        ...
        (v.updateSlidesSize = function() {
          ...
          "string" == typeof a &&
            ...
            (v.virtualSize = -a),
            v.rtl
              ? v.slides.css({ marginLeft: "", marginTop: "" })
          ...
          0 === v.snapGrid.length && (v.snapGrid = [0]),
            0 !== v.params.spaceBetween &&
              (r()
                ? v.rtl
                  ? v.slides.css({ marginLeft: a + "px" })
                  : v.slides.css({ marginRight: a + "px" })
                : v.slides.css({ marginBottom: a + "px" })),
        ...
        (v.updateClasses = function() {
          ...
          if (
            (a.addClass(v.params.slideActiveClass),
            ...
            v.params.loop
              ...
              v.paginationContainer.length > 1
                ? v.bullets.each(function() {
                    e(this).index() === t &&
                      e(this).addClass(v.params.bulletActiveClass);
                  })
          ...
          v.params.loop ||
            (v.params.prevButton &&
              (v.isBeginning
                ? (e(v.params.prevButton).addClass(
                    v.params.buttonDisabledClass
                  ),
                  v.params.a11y &&
                    v.a11y &&
                    v.a11y.disable(e(v.params.prevButton)))
                : (e(v.params.prevButton).removeClass(
                    v.params.buttonDisabledClass
                  ),
                  v.params.a11y &&
                    v.a11y &&
                    v.a11y.enable(e(v.params.prevButton)))),
            v.params.nextButton &&
              (v.isEnd
                ? (e(v.params.nextButton).addClass(
                    v.params.buttonDisabledClass
                  ),
                  v.params.a11y &&
                    v.a11y &&
                    v.a11y.disable(e(v.params.nextButton)))
                : (e(v.params.nextButton).removeClass(
                    v.params.buttonDisabledClass
                  ),
                  v.params.a11y &&
                    v.a11y &&
                    v.a11y.enable(e(v.params.nextButton)))));
        }),
      ...
      window.navigator.pointerEnabled
        ...
        (v.initEvents = function(a) {
          ...
          v.browser.ie
            ...
            v.params.nextButton &&
              (e(v.params.nextButton)[t]("click", v.onClickNext),
              v.params.a11y &&
                v.a11y &&
                e(v.params.nextButton)[t]("keydown", v.a11y.onEnterKey)),
            v.params.prevButton &&
              (e(v.params.prevButton)[t]("click", v.onClickPrev),
              v.params.a11y &&
                v.a11y &&
                e(v.params.prevButton)[t]("keydown", v.a11y.onEnterKey)),
            v.params.pagination &&
              v.params.paginationClickable &&
              (e(v.paginationContainer)[t](
                "click",
                "." + v.params.bulletClass,
                v.onClickIndex
              ),
      ...
      if (
        ...
        (v.onTouchMove = function(a) {
          if (
            (a.originalEvent && (a = a.originalEvent),
            !((D && "mousemove" === a.type) || a.preventedByNestedSwiper))
          ) {
            ...
            if (
              ...
              if (
                (x && v.emit("onTouchMoveOpposite", v, a),
                "undefined" == typeof L &&
                  v.browser.ieTouch &&
          ...
          if (
            ...
            if (
              (v.allowClick &&
                  ...
                  (P = setTimeout(function() {
                    v &&
                      (v.params.paginationHide &&
                        v.paginationContainer.length > 0 &&
                        !e(a.target).hasClass(v.params.bulletClass) &&
                ...
                300 > s &&
                  300 > t - E &&
                  (P && clearTimeout(P), v.emit("onDoubleTap", v, a))),
              (E = Date.now()),
              setTimeout(function() {
                v && (v.allowClick = !0);
              }, 0),
            ...
            if (
              ...
              if (r > -v.maxTranslate())
                return void (v.slides.length < v.snapGrid.length
              ...
              if (v.params.freeModeMomentum) {
                ...
                if (0 !== v.velocity)
                  p = v.rtl
                    ? Math.abs((-c - v.translate) / v.velocity)
                    : Math.abs((c - v.translate) / v.velocity);
            ...
            if (s > v.params.longSwipesMs) {
              ...
              "next" === v.swipeDirection &&
                (I >= v.params.longSwipesRatio
                  ? v.slideTo(x + v.params.slidesPerGroup)
                  : v.slideTo(x)),
                "prev" === v.swipeDirection &&
        ...
        (v.slideNext = function(e, a, t) {
          return v.params.loop
            ? v.animating
              ? !1
              : (v.fixLoop(),
                v.container[0].clientLeft,
                v.slideTo(v.activeIndex + v.params.slidesPerGroup, a, e, t))
            : v.slideTo(v.activeIndex + v.params.slidesPerGroup, a, e, t);
        }),
        ...
        (v.slidePrev = function(e, a, t) {
          return v.params.loop
            ? v.animating
              ...
              : (v.fixLoop(),
                v.container[0].clientLeft,
                v.slideTo(v.activeIndex - 1, a, e, t))
            : v.slideTo(v.activeIndex - 1, a, e, t);
        }),
          ...
          r() ? (s = v.rtl ? -e : e) : (n = e),
            ...
            v.params.virtualTranslate ||
              (v.support.transforms3d
                ...
                : v.wrapper.transform("translate(" + s + "px, " + n + "px)")),
            (v.translate = r() ? s : n),
        ...
        (v.createLoop = function() {
          ...
          "auto" !== v.params.slidesPerView ||
            ...
            (v.params.loopedSlides = a.length),
          ...
          for (
            a.each(function(t, i) {
              ...
              t < v.loopedSlides && r.push(i),
                t < a.length && t >= a.length - v.loopedSlides && s.push(i),
            ...
            v.wrapper.append(
              e(r[t].cloneNode(!0)).addClass(v.params.slideDuplicateClass)
            );
          for (t = s.length - 1; t >= 0; t--)
            v.wrapper.prepend(
              e(s[t].cloneNode(!0)).addClass(v.params.slideDuplicateClass)
            );
        }),
        ...
        (v.appendSlide = function(e) {
          if (
            (v.params.loop && v.destroyLoop(), "object" == typeof e && e.length)
          )
          ...
          cube: {
            setTranslate: function() {
              ...
              v.params.cube.shadow &&
                (r()
                  ? ((a = v.wrapper.find(".swiper-cube-shadow")),
                    0 === a.length &&
                      ((a = e('<div class="swiper-cube-shadow"></div>')),
                      v.wrapper.append(a)),
                    a.css({ height: v.width + "px" }))
        ...
        (v.lazy = {
          ...
          load: function() {
            ...
            if (v.params.watchSlidesVisibility)
              ...
              for (
                a = v.activeIndex;
                a < v.activeIndex + v.params.slidesPerView;
                a++
              )
        ...
        (v.scrollbar = {
          ...
          enableDraggable: function() {
            var a = v.scrollbar,
              t = v.support.touch ? a.track : document;
            e(a.track).on(v.touchEvents.start, a.dragStart),
              e(t).on(v.touchEvents.move, a.dragMove),
              e(t).on(v.touchEvents.end, a.dragEnd);
          },
          disableDraggable: function() {
            var a = v.scrollbar,
              t = v.support.touch ? a.track : document;
            e(a.track).off(v.touchEvents.start, a.dragStart),
              e(t).off(v.touchEvents.move, a.dragMove),
              e(t).off(v.touchEvents.end, a.dragEnd);
          },
          set: function() {
            if (v.params.scrollbar) {
              var a = v.scrollbar;
              (a.track = e(v.params.scrollbar)),
      ...
      return (
        ...
        (v.a11y = {
          ...
          onEnterKey: function(a) {
            13 === a.keyCode &&
              (e(a.target).is(v.params.nextButton)
                ? (v.onClickNext(a),
                  v.isEnd
                    ? v.a11y.notify(v.params.lastSlideMessage)
                    : v.a11y.notify(v.params.nextSlideMessage))
                : e(a.target).is(v.params.prevButton) &&
                  (v.onClickPrev(a),
                  v.isBeginning
                    ? v.a11y.notify(v.params.firstSlideMessage)
                    : v.a11y.notify(v.params.prevSlideMessage)),
              e(a.target).is("." + v.params.bulletClass) &&
                e(a.target)[0].click());
          },
          liveRegion: e(
        ...
        (v.cleanupStyles = function() {
          v.container.removeClass(v.classNames.join(" ")).removeAttr("style"),
            ...
            v.bullets &&
              ...
              v.bullets.removeClass(v.params.bulletActiveClass),
            v.params.prevButton &&
              e(v.params.prevButton).removeClass(v.params.buttonDisabledClass),
            v.params.nextButton &&
              e(v.params.nextButton).removeClass(v.params.buttonDisabledClass),
            v.params.scrollbar &&
              v.scrollbar &&
              (v.scrollbar.track &&
  ...
  (function($, window, document, undefined) {
    ...
    ($.fn.lazyload = function(options) {
      ...
      return (
        options &&
          (undefined !== options.failurelimit &&
            ((options.failure_limit = options.failurelimit),
            delete options.failurelimit),
          undefined !== options.effectspeed &&
        ...
        this.each(function() {
          var self = this,
            $self = $(self);
          (self.loaded = !1),
            ($self.attr("src") === undefined || $self.attr("src") === !1) &&
              $self.is("img") &&
  ...
  function g(a, c, b) {
    return b.contentWindow.postMessage
      ? ((a = JSON.stringify({ method: a, value: c })),
        void b.contentWindow.postMessage(a, h))
      : !1;
  }
  function l(a) {
    var c, b;
    ...
    return (
      ...
      c
        ? (void 0 !== a && b.push(a),
          m && b.push(m),
          f && b.push(f),
          0 < b.length ? c.apply(null, b) : c.call())
        : !1
    );
  }
  function n(a, c, b) {
...
$(document).ready(function() {
  $(".projects-archive-page").length > 0 &&
    ((is_work_page = !0),
    ...
    is_work_page || init_lazyload(),
    is_work_page && init_grid(),
    $(window).load(function() {
      updateGrid(),
        is_work_page &&
          ($(
            "html.opacity .masonry, html.opacity .project-masonry, html.opacity .work-page-masonry"
          )
            .find("img")
...
$(document).ready(function() {
  $(".masonry-element").click(function() {
    ...
    $(".credits-title").click(function() {
      $(".credits").slideToggle(), $(this).toggleClass("open");
    }),
    $(".no-touch .related-project .related-project-hover").each(function() {
      $(this).css("bottom", -$(this).height());
    }),
    $(".no-touch .related-project").hover(
      function() {
    ...
    $(window).resize(function() {
      $(".no-touch .masonry-element .project-text").each(function() {
        ...
        $(".contact-map iframe")
          ...
          .height((9 * $(".contact-map").width()) / 16),
        $(window).width() < 1024 &&
          $(".contact-map iframe").attr(
            "src",
            $(".contact-map iframe").attr("src")
          ),
        $(".slides")
          .stop()
          .css({ left: -$(".dot.current").index() * $("body").width() });
    }),
    $(window).load(function() {
      autoplay_vimeo();
    });
